...
speed_test() {
    local speedtest=$(wget --user-agent="Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3102.0 Safari/537.36" -4O /dev/null -T15 $1 2>&1 | awk '/\/dev\/null/ {speed=$3 $4} END {gsub(/\(|\)/,"",speed); print speed}')
...
speed() {
    #speed_test 'http://cq2.cqwin.com/lantest.bin' 'China, 10010, 800MB'
    speed_test 'http://speed.189.cn/upload/BSSAClientSetup9.exe' 'China, 189, 30MB'
    speed_test 'http://cachefly.cachefly.net/100mb.test' 'CacheFly'
    speed_test 'http://speedtest.tokyo.linode.com/100MB-tokyo.bin' 'Linode, Tokyo, JP'
    speed_test 'http://hnd-jp-ping.vultr.com/vultr.com.100MB.bin' 'Vultr, Tokyo, JP'
    speed_test 'http://lax-ca-us-ping.vultr.com/vultr.com.100MB.bin' 'Vultr, LosAngeles'
    speed_test 'http://speedtest-sfo1.digitalocean.com/100mb.test' 'DigitalOcean, LosAngeles1'
